...
<img width="1600" height="901" alt="image" src="https://github.com/user-attachments/assets/8d4d6df7-4bad-48f2-ae09-fe6841511217" />
...
<img width="1600" height="901" alt="image" src="https://github.com/user-attachments/assets/00f445d8-01ee-4339-b276-60f9969743ae" />
...
```mermaid
graph LR
    A[Automation<br/>'Do this task'<br/>You = Script Writer] -->|more AI freedom| B[Augmentation<br/>'Let's think together'<br/>You = Co-creator]
    B -->|more AI freedom| C[Agency<br/>'Pursue this goal'<br/>You = Director]
```
...
<img width="1600" height="901" alt="image" src="https://github.com/user-attachments/assets/b044f08f-499c-41f8-bb72-c9dde75ca5eb" />
...
<img width="1600" height="878" alt="image" src="https://github.com/user-attachments/assets/a79925fc-fab4-42f3-b443-53d2496611d5" />
...
<img width="1600" height="901" alt="image" src="https://github.com/user-attachments/assets/c3d8c4bd-d2d0-4e0d-b491-5580c2bbdbe6" />
...
```mermaid
graph TD
    Describe[1. Describe<br/>state product, process, performance] --> Produces[2. AI Produces<br/>fluent & confident output]
    Produces --> Discern[3. Discern<br/>evaluate all three parts]
    Discern --> Refine[4. Refine<br/>name it, explain why, direct the fix]
    Refine --> Describe
```

<img width="1600" height="901" alt="image" src="https://github.com/user-attachments/assets/1a8563ce-a956-443b-80dd-178d082436dc" />
...
<img width="1600" height="901" alt="image" src="https://github.com/user-attachments/assets/ad26d62f-f5c3-4093-a836-5764faa7c360" />
...
```mermaid
flowchart LR
    D1["🎯 Delegate<br/>decide the split"] --> D2["📝 Describe<br/>give context"]
    D2 --> D3["🔍 Discern<br/>check the result"]
    D3 --> D4["🛡️ Be Diligent<br/>own the outcome"]
    D4 -.repeat as needed.-> D1
```
...
<img width="1600" height="936" alt="image" src="https://github.com/user-attachments/assets/f22229eb-f1b2-4b02-b1a8-e43a64f3dc47" />
